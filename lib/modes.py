...
MODE_STRINGS = {
    ...
    lib.mypaintlib.CombineSpectralWGM: (
        _("Pigment"),
        _(
            "Similar to mixing actual pigments by upsampling "
    ...
    lib.mypaintlib.CombineMultiply: (
        _("Multiply"),
        _(
            "Similar to loading two slides into a projector and "
    ...
    lib.mypaintlib.CombineScreen: (
        _("Screen"),
        _(
            "Like shining two separate slide projectors onto a screen "
    ...
    lib.mypaintlib.CombineOverlay: (
        _("Overlay"),
        _(
            "Overlays the backdrop with the top layer, preserving the "
    ...
    lib.mypaintlib.CombineColorDodge: (
        _("Dodge"),
        _(
            "Brightens the backdrop using the top layer. The effect is "
    ...
    lib.mypaintlib.CombineColorBurn: (
        _("Burn"),
        _(
            "Darkens the backdrop using the top layer. The effect looks "
            "similar to the photographic darkroom technique of the same "
    ...
    lib.mypaintlib.CombineHue: (
        _("Hue"),
        _(
            "Combines the hue of the top layer with the saturation and "
    ...
    lib.mypaintlib.CombineSaturation: (
        _("Saturation"),
        _(
            "Applies the saturation of the top layer's colors to the "
    ...
    lib.mypaintlib.CombineColor: (
        _("Color"),
        _(
            "Applies the hue and saturation of the top layer to the "
            "luminosity of the backdrop."
        ),
    ),
    lib.mypaintlib.CombineLuminosity: (
        _("Luminosity"),
        _(
            "Applies the luminosity of the top layer to the hue and "
    ...
    lib.mypaintlib.CombineDestinationIn: (
        _("Destination In"),
        _(
            "Uses the backdrop only where this layer covers it. "
    ...
    lib.mypaintlib.CombineDestinationOut: (
        _("Destination Out"),
        _(
            "Uses the backdrop only where this layer doesn't cover it. "
            "Everything else is ignored."
        ),
    ),
...
MODES_DECREASING_BACKDROP_ALPHA = {
    m
    for m in range(lib.mypaintlib.NumCombineModes)
