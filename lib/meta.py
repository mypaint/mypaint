...
def _parse_version_string(version_string):
    ...
    Returns:
        int, int, int, str) | None: the four version fields as a tuple, or None if input is invalid
...
def compatibility(target_version_string):
    ...
    Args:
        target_version_string: Version string to test against

    Returns:
        int, bool) | None: The compatibility of the current version with the target version
...
def _get_versions(gitprefix="gitexport"):
    ...
    Args:
        gitprefix (str, optional): how to denote git-derived build metainfo
    :rtype: tuple (Default value = "gitexport")

    Returns:
        all 3 version strings: (base, formal, ceremonial)
...
def _get_release_info_script(gitprefix="gitexport"):
    ...
    Args:
        gitprefix:  (Default value = "gitexport")
