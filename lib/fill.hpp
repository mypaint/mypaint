...
/* _floodfill_color_match:

Similarity metric used by flood fill.  Result is a fix15_t in the range [0.0,
1.0], with zero meaning no match close enough.  Similar algorithm to the GIMP's
pixel_difference(): a threshold is used for a "similar enough" determination.
