...
URLS=$(apt-get $OPTIONS -y install --print-uris python-gi gir1.2-gtk-3.0 python-gi-cairo libgtk-3-0 python-numpy libcanberra-gtk3-module | cut -d "'" -f 2 | grep -e "^http")
wget -c $URLS
