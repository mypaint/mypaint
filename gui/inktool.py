...
_NODE_FIELDS = ("x", "y", "pressure", "xtilt", "ytilt", "time", "barrel_rotation")
...
class InkingMode (gui.mode.ScrollableModeMixin,
    ...
    def _draw_curve_segment(self, model, p_1, p0, p1, p2, state):
        ...
        for i in xrange(int(steps) + 1):
            ...
            x, y, pressure, xtilt, ytilt, t_abs, barrel_rotation = point
            ...
            barrel_rotation = 0.0
            self.stroke_to(
                model, dtime, x, y, pressure, xtilt, ytilt, barrel_rotation,
                auto_split=False,
            )
            last_t_abs = t_abs
