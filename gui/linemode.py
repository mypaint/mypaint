...
class LineModeBase (gui.mode.ScrollableModeMixin,
    ...
    def _stroke_to(self, x, y, pressure):
        duration = 0.001
        self.stroke_to(self.model, duration, x, y, pressure, 0.0, 0.0, self.doc.tdw.scale, self.doc.tdw.rotation, 0.0,
                       auto_split=False)
    ...
    def brush_prep(self, sx, sy):
        ...
        self.stroke_to(self.model, 10.0, sx, sy, 0.0, 0.0, 0.0, self.doc.tdw.scale, self.doc.tdw.rotation, 0.0,
                       auto_split=False)
