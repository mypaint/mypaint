...
settings_list = [
    ...
    ['opaque', 'opaque', True, 0.0, 1.0, 1.0, "0 means brush is transparent, 1 fully visible"],
    ...
    ['speed2_slowness', 'speed2 slowness', False, 0.0, 1.0, 10.0, "how slow the input speed2 is following the real speed\n0.0 change immediatly as your speed changes"],
